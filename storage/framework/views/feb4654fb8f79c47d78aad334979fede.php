            ...
            <div class="hidden lg:flex lg:w-1/2 bg-gradient-to-br from-blue-600 via-blue-700 to-indigo-800 p-12 flex-col justify-between relative overflow-hidden">
                ...
                <div class="relative z-10">
                    <div class="flex items-center space-x-3">
                        ...
                        <span class="text-2xl font-bold text-white"><?php echo e(\App\Models\Setting::get('app_name', 'Assets Management')); ?></span>
                    </div>
                </div>
                ...
                <div class="relative z-10 text-blue-200 text-sm">
                    &copy; <?php echo e(date('Y')); ?> <?php echo e(\App\Models\Setting::get('app_name', 'Assets Management')); ?>. All rights reserved.
                </div>
            </div>
            ...
            <div class="w-full lg:w-1/2 flex flex-col justify-center items-center p-8 bg-gray-50">
                <div class="w-full max-w-md">
                    ...
                    <div class="lg:hidden flex items-center justify-center space-x-3 mb-8">
                        ...
                        <span class="text-xl font-bold text-gray-800"><?php echo e(\App\Models\Setting::get('app_name', 'Assets Management')); ?></span>
                    </div>
                    ...
                    <p class="text-center text-gray-500 text-sm mt-6 lg:hidden">
                        &copy; <?php echo e(date('Y')); ?> <?php echo e(\App\Models\Setting::get('app_name', 'Assets Management')); ?>
...
<?php /**PATH D:\Assets\assets-management\resources\views/layouts/guest.blade.php ENDPATH**/ ?>